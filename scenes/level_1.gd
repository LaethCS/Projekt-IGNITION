...
@onready var win_label = $WinUI/WinLabel # Ersetze den Pfad durch deinen tatsächlichen Pfad zum Label
@onready var win_sound = $WinUI/WinLabel/win_soundeffect # Pfad zu deinem neuen Sound-Knoten
func _ready():
